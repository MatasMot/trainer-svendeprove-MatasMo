    ...
    return (
        <>
            ...
            <section className="flex overflow-x-scroll gap-4 scrollbar-hide">
                {classes.map(classes => (
                    <article className="basis-[380px] grow-0 shrink-0" key={classes.id}>
                        <p>Class name: {classes.className}</p>
                        <img className="rounded-tl-[5rem]" src={classes.asset.url} alt="url" />
